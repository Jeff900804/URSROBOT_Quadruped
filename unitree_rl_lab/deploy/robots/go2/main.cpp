...
int main(int argc, char** argv)
{
    ...
    spdlog::info("[AutoFSM] Request FixStand");
    fsm_ptr->requestState("FixStand");

    std::this_thread::sleep_for(3s);
    spdlog::info("[AutoFSM] Request Velocity");
    fsm_ptr->requestState("Velocity");

    //std::this_thread::sleep_for(10s);
    //spdlog::info("[AutoFSM] Request Velocity_flat");
    //fsm_ptr->requestState("Velocity_flat");
