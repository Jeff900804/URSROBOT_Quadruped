...
from unitree_rl_lab.assets.robots.unitree import UNITREE_GO1_CFG as ROBOT_CFG
...
#         ray_alignment="yaw",
#         pattern_cfg=patterns.GridPatternCfg(resolution=0.1, size=[0.8, 0.8]),
#         debug_vis=False,
...
class RewardsCfg:
    ...
    action_rate = RewTerm(func=mdp.action_rate_l2, weight=-0.1) #-0.1
    dof_pos_limits = RewTerm(func=mdp.joint_pos_limits, weight=-10.0) #-10.0
    ...
    joint_pos = RewTerm(
        ...
        params={
            ...
            "stand_still_scale": 5.0, #5.0
            "velocity_threshold": 0.3, #0.3
        },
    )
    ...
    hole_td = RewTerm(
        ...
        params={
            ...
            "event_penalty": 3.0,   # 5.0 先大一點，之後再調
            "command_name": "base_velocity",
            "min_cmd_x": 0.2,
        },
